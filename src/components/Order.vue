    ...
    <div class="container">
        <div class="columns">
            ...
            <div class="column is-4">
                ...
                <div class="field">
                    ...
                    <input id="card_number" v-model="card.number" type="text" :class="['is-danger' ? cardNumberError :
                ...
                <div class="field">
                    ...
                    <input id="exp_month" v-model="card.exp_month" type="text" :class="['is-danger' ? cardMonthError :
                ...
                <div class="field">
                    ...
                    <input id="exp_year" v-model="card.exp_year" type="text" :class="['is-danger' ? cardYearError :
            ...
            <div class="column is-4">
                ...
                <textarea class="textarea" placeholder="What would you like the note to say?"
                          v-model="specialNote"></textarea>
                <hr>
                <div class="field">
                    <label>Address</label>
        ...
        <div class="columns">
            <div class="column is-12">
                <button type="submit" class="button is-primary is-large is-pulled-right" @click.prevent="validate"
...
<script>
    ...
    export default {
        data(){
            return {
                stripeKey: 'pk_test_Ui8MK9W79uOpFNWzc9BVAumX',
                name: '',
                email: '',
                specialNote: '',
                address: {
